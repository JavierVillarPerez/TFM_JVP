...
#define RadioSpiCSLow()        HAL_GPIO_WritePin(GPIOA, SPI_CS_S2_LP_Pin, GPIO_PIN_RESET)
#define RadioSpiCSHigh()       HAL_GPIO_WritePin(GPIOA, SPI_CS_S2_LP_Pin, GPIO_PIN_SET)
